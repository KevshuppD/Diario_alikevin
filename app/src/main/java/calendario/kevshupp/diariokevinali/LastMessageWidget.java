...
public class LastMessageWidget extends AppWidgetProvider {
        ...
        if (coupleId != null && myId != null) {
            FirebaseFirestore.getInstance().collection("messages")
                ...
                .addOnSuccessListener(querySnapshot -> {
                    ...
                    String titleText = "Mensaje de " + senderName;
                    if (timestamp != null) {
                        String dayStr;
                        if (isSameDay(timestamp, System.currentTimeMillis())) {
                            ...
                            SimpleDateFormat sdf = new SimpleDateFormat("EEEE d", new Locale("es", "ES"));
                            dayStr = sdf.format(new Date(timestamp));
    ...
    private static boolean isYesterday(long timestamp) {
        ...
        return isSameDay(timestamp, cal.getTimeInMillis());
    }
}